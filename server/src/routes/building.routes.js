...
router.post("/demolish", async (req,res)=>{
    ...
    try {
        ...
        const result =
            await buildingService.demolishBuilding(
                req.body.cityId,
                req.body.buildingId
            );
...
router.get("/city/:cityId", async (req, res) => {
    try {
        // Settle any construction/upgrades/demolitions whose finish_time has
        // already passed BEFORE reading buildings, so what we return is current.
